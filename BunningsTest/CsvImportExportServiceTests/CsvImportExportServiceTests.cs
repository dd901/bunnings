    ...
    public class CsvImportExportServiceTests
    {
       [Test]
        ...
        public void Given_Invalid_Input_File_When_I_Import_Then_An_Exception_Should_Be_Thrown()
        {
           ...
           Assert.Throws<CsvHelper.TypeConversion.TypeConverterException>(() => new CsvImportExportService().Import<SupplierProductBarcode>(fileToImport) );
        ...
        public void Given_A_File_To_Export_When_Export_Then_Ensure_A_File_Has_Been_Created()
        {
            ...
            {
                new CommonCatalog("1", "pots", "A"),
                new CommonCatalog("2", "pans", "A"),
                new CommonCatalog("3", "paper", "B"),
                new CommonCatalog("4", "knife", "B"),
                new CommonCatalog("5", "spoon", "B"),
            };
            //act
            new CsvImportExportService().Export<CommonCatalog>("export.csv", commonCatalogs );
